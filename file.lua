...
local PageForBar = MenuContainer:WaitForChild("Page")
local HubBar = PageForBar:WaitForChild("HubBar")
local TabHeader = HubBar:WaitForChild("TabHeaderContainer")
local HubBarContainer = TabHeader:FindFirstChild("HubBarContainer")
local PageViewClipper = PageForBar:WaitForChild("PageViewClipper")
